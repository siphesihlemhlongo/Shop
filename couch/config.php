<?php
    ...
    define( 'K_DB_NAME', 'kuhleshop' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'kuhleshop' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'Siphesihle@07' );
    // 7.
